...
<button type="submit" name="add_maison" class='btn btn-primary'>Enter</button> <br>
<button type="submit" id="goo"  class='btn btn-primary'><a href="../location/Chefchaoun.php"> Goo See </a></button>
</form>
</section>
